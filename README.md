...
- 📝 主要开发语言（JavaScript、TypeScript、Python、Java等）
- 🏗️ 前端框架（React、Vue、Angular等）
- ⚙️ 后端框架（Go、Express、Django、Spring等）
- 🗄️ 数据库类型（MySQL、PostgreSQL、MongoDB等）
- 🚀 部署平台（Docker、AWS、Vercel、Supabase等）
...
- 📝 添加项目特定的规则和约定
- 🔧 技术栈信息会自动更新到规则文件中（使用init.sh可自动完成）

### 4️⃣ 创建计划

- 📝 通过和 AI 对话，可以自动创建计划：“我有如下的需求，请帮我分析需求的复杂程度，制定开发计划并保存”
